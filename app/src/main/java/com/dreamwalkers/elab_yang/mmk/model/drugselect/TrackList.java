...
public class TrackList {
    public final static List<Track> TRACKS = new ArrayList<Track>(){{
        add(new Track("Dead Inside", "Muse", R.drawable.ic_syringe_rrpid));
        add(new Track("Sandman", "Hurts", R.drawable.ic_syringe_rrpid));
        add(new Track("Doing It to Death", "The Kills", R.drawable.ic_syringe_rrpid));
