...
public class SpaceTabLayout extends RelativeLayout {
    ...
    private void init() {
        LayoutInflater.from(getContext()).inflate(eu.long1.spacetablayout.R.layout.three_tab_space_layout, this);
        ...
        defaultTabOneButtonIcon = getContext().getResources().getDrawable(eu.long1.spacetablayout.R.drawable.ic_tab_one);
        defaultTabTwoButtonIcon = getContext().getResources().getDrawable(eu.long1.spacetablayout.R.drawable.ic_tab_two);
        defaultTabThreeButtonIcon = getContext().getResources().getDrawable(eu.long1.spacetablayout.R.drawable.ic_tab_three);
        defaultTabFourButtonIcon = getContext().getResources().getDrawable(eu.long1.spacetablayout.R.drawable.ic_tab_four);
        defaultTabFiveButtonIcon = getContext().getResources().getDrawable(eu.long1.spacetablayout.R.drawable.ic_tab_five);

        defaultTextColor = ContextCompat.getColor(getContext(), android.R.color.primary_text_dark);

        defaultButtonColor = ContextCompat.getColor(getContext(), eu.long1.spacetablayout.R.color.colorAccent);

        defaultTabColor = ContextCompat.getColor(getContext(), eu.long1.spacetablayout.R.color.colorPrimary);
    }

    private void initArrts(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, eu.long1.spacetablayout.R.styleable.SpaceTabLayout);
    ...
    public void setTabColor(@ColorInt int backgroundColor) {
        ...
        Drawable image = ContextCompat.getDrawable(getContext(), eu.long1.spacetablayout.R.drawable.background);
        Drawable image2 = ContextCompat.getDrawable(getContext(), eu.long1.spacetablayout.R.drawable.background2);
